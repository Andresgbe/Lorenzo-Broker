...
export function Hero() {
  return (
    <section
      ...
      className="pt-16 sm:pt-[110px] pb-16 sm:pb-[90px] bg-[radial-gradient(900px_420px_at_70%_-10%,rgba(37,233,138,0.09),transparent_60%),radial-gradient(700px_380px_at_10%_110%,rgba(37,233,138,0.05),transparent_60%)]"
    >
      <Container className="flex flex-col items-center text-center">
        <motion.div
          ...
          className="w-full max-w-5xl bg-panel border border-line rounded-[20px] p-4 sm:p-7 shadow-[0_30px_80px_rgba(0,0,0,0.5)]"
        >
          <VideoPlayer
        ...
        >
          <h1 className="font-display font-extrabold text-[clamp(34px,5.4vw,62px)] leading-[1.12] text-ink text-balance max-w-5xl mx-auto">
            Aprende bolsa con un <span className="text-accent">corredor real</span>, operando en vivo.
          </h1>
          <p className="text-muted text-[17px] sm:text-lg mt-6 mb-9 max-w-3xl mx-auto">
          ...
          <div className="mt-12 grid grid-cols-3 gap-4 sm:flex sm:flex-wrap sm:justify-center sm:gap-10">
            {STATS.map((stat) => (
              <div key={stat.value}>
